<div class="ummah-subscription">
    <div class="title">Join the Umma's newsletter:</div>
...
<div class="ummah-footer">
    <div class="footer-content">
        <div class="footer-logo">
            <a href="<?php echo WEBSITE_URL;?>"><img src="<?php echo ASSETS_URL;?>images/footer-logo.png" alt="UMMA LOGO"/></a>
        </div>
        <p class="footer-featured-line">UNITED MICHIGAN MUSLIM ASSOCIATION</p>
